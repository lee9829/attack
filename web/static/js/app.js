  ...
  function collectConfig() {
    ...
    return {
      ...
      search_flow: {
        ...
        require_regex: $("#requireRegex") ? $("#requireRegex").checked : true,
        require_domain: $("#requireDomain").checked,
        skip_ads: $("#skipAds").checked,
        ...
        human: {
          dwell_ms_min: Number($("#dwellMin").value || 4000),
          dwell_ms_max: Number($("#dwellMax").value || 12000),
          scroll: $("#humanScroll").checked,
          mouse_wander: $("#mouseWander").checked,
          read_pauses: $("#readPauses").checked,
          scroll_steps_min: 3,
          scroll_steps_max: 8,
