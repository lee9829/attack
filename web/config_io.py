...
def default_config() -> Dict[str, Any]:
    return {
        ...
        "search_flow": {
            ...
            # 프로필마다 검색어 순서 다르게 → 다양한 조회 + 1클릭
            "keyword_rotate": True,
            "keyword_shuffle": True,
            "one_keyword_per_job": False,
            "single_click": True,
            "prefer_ads": False,
            "target_domain": "",
            "allowed_domains": [],
            ...
            "require_domain": True,
            # False = 구글 광고(스폰서) 결과도 매칭 대상 (불법 광고 추적)
            "skip_ads": False,
